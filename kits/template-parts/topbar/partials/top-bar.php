<?php
$top_bar_left = get_theme_mod('_themename_top_bar_left');
$top_bar_right = get_theme_mod('_themename_top_bar_right');
$top_bar_mobile = _themename_theme()->get_option('top_bar_mobile');
$hide_top_bar_mobile = '';
if( $top_bar_mobile != 0 ) {
...
<div class="top-bar-wrap <?php echo esc_attr($hide_top_bar_mobile); ?>">
	<div class="<?php echo esc_attr(_themename_theme()->get_option('top_bar_width')); ?>">
		<div class="d-flex justify-content-between">
			<div class="top-bar-left-wrap">
				...
				if( $top_bar_left != 'none' ) {
                    ...
                    } elseif ( $top_bar_left == 'yani_switchers' ) {
			...
			<div class="top-bar-right-wrap">
				...
				if( $top_bar_right != 'none' ) {
                    ...
                    } elseif ( $top_bar_right == 'yani_switchers' ) {
                        get_template_part( 'template-parts/topbar/partials/currency-switcher' );
                        get_template_part( 'template-parts/topbar/partials/area-switcher' );
