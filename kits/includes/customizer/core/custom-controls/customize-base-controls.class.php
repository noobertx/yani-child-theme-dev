<?php
/**
 * Noonie customizer base control class for theme customize options.
 *
 * Class Noonie_Customize_Base_Control
 *
 * @package    ThemeGrill
 * @subpackage Noonie
 * @since      Noonie 1.0.0
...
/**
 * Noonie customizer base control class.
 *
 * Class Noonie_Customize_Base_Control
 */
class Noonie_Customize_Base_Control {
...
return new Noonie_Customize_Base_Control();
