 ...
 * Class ColorMag_Customize_Site_Identity_Options
 */
class Noonie_Customize_Site_Identity_Options extends Noonie_Customize_Base_Option {
	...
	public function register_options( $options, $wp_customize ) {
		...
		$configs = array(
			array(
				'name'     => '_themename_slogan',
				'type'     => 'control',
				'control'  => 'colormag-title',
				'label'    => esc_html__( 'Slogan', 'colormag' ),
				'section'  => 'title_tagline',
				'priority' => 11,
			),
			array(
				'name'     => '_themename_phone',
				'type'     => 'control',
				'control'  => 'colormag-title',
				'label'    => esc_html__( 'Phone', 'colormag' ),
				'section'  => 'title_tagline',
				'priority' => 11,
			),
			array(
				'name'     => '_themename_email',
				'type'     => 'control',
				'control'  => 'colormag-title',
			...
			array(
				'name'     => '_themename_top_bar_left',
				'default'  => 'none',
				'type'     => 'control',
				'control'  => 'select',
				'label'    => esc_html__( 'Top Bar Left', 'colormag' ),
				'section'  => 'noonie_top_bar_section',
				'choices'  => array(
					'none' => esc_html__( 'None', 'colormag' ),
					'menu_bar' => esc_html__( 'Menu ( Create and assing menu under Appearance -> Menus )', 'colormag' ),
					'social_icons'        => esc_html__( 'Social Icons', 'colormag' ),
					'contact_info'          => esc_html__( 'Contact Info', 'colormag' ),
					'slogan'          => esc_html__( 'Slogan', 'colormag' ),
					'_themename_switchers'          => esc_html__( 'Currency Switcher + Area Switcher', 'colormag' ),
				),
				'priority' => 31,
			),

			array(
				'name'     => '_themename_top_bar_right',
				'default'  => 'none',
				'type'     => 'control',
				'control'  => 'select',
				'label'    => esc_html__( 'Top Bar Right', 'colormag' ),
				'section'  => 'noonie_top_bar_section',
				'choices'  => array(
					'none' => esc_html__( 'None', 'colormag' ),
					'menu_bar' => esc_html__( 'Menu ( Create and assing menu under Appearance -> Menus )', 'colormag' ),
...
return new Noonie_Customize_Site_Identity_Options();
