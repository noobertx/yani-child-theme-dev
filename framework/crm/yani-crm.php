<?php
  final class yani_CRM {
        ...
        public function __construct() {
            ...
            do_action( 'yani_crm_loaded' );  // Houzez CRM plugin action hook loaded
        }
        ...
        protected function define_constants() {
            ...
            // if ( ! defined( 'yani_CRM_VERSION' ) ) {
            //     define( 'yani_CRM_VERSION', $this->version );
            // }

            // if ( ! defined( 'yani_CRM_PLUGIN_FILE' ) ) {
            //     define( 'yani_CRM_PLUGIN_FILE', __FILE__ );
            // }

            if ( ! defined( 'YANI_CRM_DIR' ) ) {
                define( 'YANI_CRM_DIR', YANI_THEME_FRAMEWORK_DIR."crm/" );
            }

            if ( ! defined( 'yani_CRM_URL' ) ) {
                define( 'yani_CRM_URL', YANI_THEME_FRAMEWORK_URI."crm/" );
            }

            // if ( ! defined( 'yani_CRM_BASENAME' ) ) {
            //     define( 'yani_CRM_BASENAME', plugin_basename( __FILE__ ) );
            // }
        ...
        public function enqueue_scripts() {
            ...
            if(self::is_crm_page()) {
                ...
                $yani_date_language = _yani_theme()->get_option('yani_date_language');
                $yani_date_language = esc_html($yani_date_language);

                if (function_exists('icl_translate')) {
                    $yani_date_language = ICL_LANGUAGE_CODE;
                }
                wp_enqueue_script( 'houzez-crm-script', yani_CRM_URL . 'js/script.js', 'jquery', $this->version, true );
                ...
                wp_localize_script( 'houzez-crm-script', 'yani_crm_vars', $locals ); 
            }
        }
        ...
        public function include_files() {
            include_once( YANI_CRM_DIR . 'includes/settings/settings-init.php' ); 
            include_once( YANI_CRM_DIR . 'includes/class-activities.php' ); 
            include_once( YANI_CRM_DIR . 'includes/class-notes.php' ); 
            include_once( YANI_CRM_DIR . 'includes/class-leads.php' ); 
            include_once( YANI_CRM_DIR . 'includes/class-enquiry.php' ); 
            include_once( YANI_CRM_DIR . 'includes/class-collect-form-data.php' ); 
            include_once( YANI_CRM_DIR . 'includes/class-deals.php' ); 
            include_once( YANI_CRM_DIR . 'includes/class-viewed.php' ); 
            include_once( YANI_CRM_DIR . 'includes/functions.php' ); 
        }
        ...
        public function load_plugin_textdomain() {
            load_plugin_textdomain( 'houzez-crm', false, dirname( yani_CRM_BASENAME ) . '/languages' );
        }
        ...
        public function plugin_activation() {
            ...
            $table_name         = $wpdb->prefix . 'yani_crm_leads';
            ...
            $table_name         = $wpdb->prefix . 'yani_crm_enquiries';
            $sql = "CREATE TABLE $table_name (
            ...
            $table_name         = $wpdb->prefix . 'yani_crm_deals';
            $sql = "CREATE TABLE $table_name (
            ...
            $table_name         = $wpdb->prefix . 'yani_crm_activities';
            $sql = "CREATE TABLE $table_name (
            ...
            $table_name         = $wpdb->prefix . 'yani_crm_notes';
            $sql = "CREATE TABLE $table_name (
        ...
        public function __wakeup() {
            _doing_it_wrong( __FUNCTION__, __( 'Not good; huh?', 'houzez-crm' ), yani_CRM_VERSION );
        }
