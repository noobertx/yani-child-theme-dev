<?php
if ( ! class_exists( 'yani_Deals' ) ) {

	class yani_Deals {

		public function __construct() {
			add_action( 'wp_ajax_yani_crm_add_deal', array( $this, 'add_new_deal' ) );
			...
			add_action( 'wp_ajax_yani_delete_deal', array( $this, 'delete_deal' ) );
		}
		...
		public function set_action_due_date() {
			...
			$data_table        = $wpdb->prefix . 'yani_crm_deals';
	        $data = array(
