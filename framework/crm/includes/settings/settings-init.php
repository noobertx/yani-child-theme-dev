...
if ( file_exists( YANI_CRM_DIR . 'includes/settings/class-crm-settings-api.php' ) ) {
    include_once( YANI_CRM_DIR . 'includes/settings/class-crm-settings-api.php' );
}
...
if ( class_exists( 'WP_OSA' ) ) {
	 ...
	 * @since 1.0.0
	 */
	if ( file_exists( YANI_CRM_DIR . 'includes/settings/lead-settings.php' ) ) {
	    include_once( YANI_CRM_DIR . 'includes/settings/lead-settings.php' );
	}
	 ...
	 * @since 1.0.0
	 */
	if ( file_exists( YANI_CRM_DIR . 'includes/settings/enquiry-settings.php' ) ) {
	    include_once( YANI_CRM_DIR . 'includes/settings/enquiry-settings.php' );
	}
	 ...
	 * @since 1.0.0
	 */
	if ( file_exists( YANI_CRM_DIR . 'includes/settings/deals-settings.php' ) ) {
	    include_once( YANI_CRM_DIR . 'includes/settings/deals-settings.php' );
	}
