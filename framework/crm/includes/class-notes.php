<?php
if ( ! class_exists( 'yani_CRM_Notes' ) ) {

	class yani_CRM_Notes {

		
		public function __construct() {
			add_action( 'wp_ajax_yani_crm_add_note', array( $this, 'add_note' ) );
			add_action( 'wp_ajax_yani_delete_note', array( $this, 'delete_note') );
		}
            	...
            	<div id="note-<?php echo intval($note_id); ?>" class="private-note-wrap" style="display: none;">
	                ...
	                <div class="text-right">
	                    <a class="delete_note" data-id="<?php echo intval($result->note_id); ?>" href="#" class="ml-3">
	                        <i class="yani-icon icon-remove-circle mr-1"></i> 
