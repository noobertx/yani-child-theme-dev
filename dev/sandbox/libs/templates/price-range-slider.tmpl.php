...
<div class="range-text">
	...
	<span class="range-title"><?php echo _yani_theme()->get_option('srh_price_range', 'Price Range:'); ?></span> <?php echo _yani_theme()->get_option('srh_from', 'from'); ?> <span class="min-price-range"></span> <?php echo _yani_theme()->get_option('srh_to', 'to'); ?> <span class="max-price-range"></span>
</div><!-- range-text -->
