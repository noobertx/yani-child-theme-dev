(function($){
    ...
    if ( typeof yani_vars !== "undefined" ) {
        ...
        var ajax_url = yani_vars.ajaxurl;
        var is_edit_property = yani_vars.is_edit_property;
        var yani_logged_in = yani_vars.yani_logged_in;
        var login_sending = yani_vars.login_loading;
        var process_loader_refresh = yani_vars.process_loader_refresh;
        var process_loader_spinner = yani_vars.process_loader_spinner;
        var process_loader_circle = yani_vars.process_loader_circle;
        var process_loader_cog = yani_vars.process_loader_cog;
        var success_icon = yani_vars.success_icon;
        var verify_nonce = yani_vars.verify_nonce;
        var verify_file_type = yani_vars.verify_file_type;
        var msg_digits = yani_vars.msg_digits;
        var max_prop_images = yani_vars.max_prop_images;
        var image_max_file_size = yani_vars.image_max_file_size;
        var max_prop_attachments = yani_vars.max_prop_attachments;
        var attachment_max_file_size = yani_vars.attachment_max_file_size;
        var add_listing_msg = yani_vars.add_listing_msg;
        var processing_text = yani_vars.processing_text;

        var plan_title_text = yani_vars.plan_title_text;
        var plan_size_text = yani_vars.plan_size_text;
        var plan_bedrooms_text = yani_vars.plan_bedrooms_text;
        var plan_bathrooms_text = yani_vars.plan_bathrooms_text;
        var plan_price_text = yani_vars.plan_price_text;
        var plan_price_postfix_text = yani_vars.plan_price_postfix_text;
        var plan_image_text = yani_vars.plan_image_text;
        var plan_description_text = yani_vars.plan_description_text;
        var plan_upload_text = yani_vars.plan_upload_text;

        var mu_title_text = yani_vars.mu_title_text;
        var mu_type_text = yani_vars.mu_type_text;
        var mu_beds_text = yani_vars.mu_beds_text;
        var mu_baths_text = yani_vars.mu_baths_text;
        var mu_size_text = yani_vars.mu_size_text;
        var mu_size_postfix_text = yani_vars.mu_size_postfix_text;
        var mu_price_text = yani_vars.mu_price_text;
        var mu_price_postfix_text = yani_vars.mu_price_postfix_text;
        var mu_availability_text = yani_vars.mu_availability_text;
        var are_you_sure_text = yani_vars.are_you_sure_text;
        var delete_btn_text = yani_vars.delete_btn_text;
        var cancel_btn_text = yani_vars.cancel_btn_text;
        var confirm_btn_text = yani_vars.confirm_btn_text;

        // For validation
        var prop_title = yani_vars.prop_title;
        var prop_price = yani_vars.prop_price;
        var prop_sec_price = yani_vars.prop_sec_price;
        var prop_type = yani_vars.prop_type;
        var prop_status = yani_vars.prop_status;
        var prop_labels = yani_vars.prop_labels;
        //var prop_description = yani_vars.description;
        var price_label = yani_vars.price_label;
        var prop_id = yani_vars.prop_id;
        var bedrooms = yani_vars.bedrooms;
        var bathrooms = yani_vars.bathrooms;
        var area_size = yani_vars.area_size;
        var land_area = yani_vars.land_area;
        var garages = yani_vars.garages;
        var year_built = yani_vars.year_built;
        var property_map_address = yani_vars.property_map_address;
        var neighborhood = yani_vars.neighborhood;
        var city = yani_vars.city;
        var state = yani_vars.state;
        var country = yani_vars.country;
        var enable_title_limit = yani_vars.enable_title_limit;
        var property_title_limit = yani_vars.property_title_limit;

        var yani_processing_modal = function ( msg ) {
        ...
        var yani_processing_modal_close = function ( ) {
        ...
        $( 'a.delete-property' ).on( 'click', function (){
                ...
                bootbox.confirm({
                message: "<strong>"+yani_vars.delete_confirmation+"</strong>",
                buttons: {
                    confirm: {
        ...
        $('.make-prop-featured').on('click', function (e) {
            ...
            bootbox.confirm({
                message: "<strong>"+yani_vars.confirm_featured+"</strong>",
                buttons: {
                    confirm: {
        ...
        var make_prop_featured = function( prop_id, currentDiv, prop_type ) {
            ...
            $.ajax({
                ...
                dataType: 'JSON',
                data: {
                    'action' : 'yani_make_prop_featured',
                    'propid' : prop_id,
                    'prop_type': prop_type
                },
                success: function ( res ) {
                    ...
                    if( res.success ) {
                        ...
                        yani_processing_modal_close();
                        $('html, body').animate({
                            scrollTop: $(".dashboard-content-inner-wrap").offset().top
                        }, 'slow');
                        $messages.empty().append('<div class="alert alert-danger alert-dismissible fade show" role="alert">'+yani_vars.featured_listings_none+'<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
                    }
        ...
        $('.remove-prop-featured').click(function (e) {
            ...
            bootbox.confirm({
                message: "<strong>"+yani_vars.confirm_featured_remove+"</strong>",
                buttons: {
                    confirm: {
                        label: confirm_btn_text,
                        className: 'btn btn-primary'
        ...
        var remove_prop_featured = function( prop_id, currentDiv ) {
            ...
            $.ajax({
                ...
                dataType: 'JSON',
                data: {
                    'action' : 'yani_remove_prop_featured',
                    'propid' : prop_id
                },
                success: function ( res ) {
                    if( res.success ) {
        ...
        var resend_for_approval = function( prop_id, currentDiv ) {
            ...
            $.ajax({
                ...
                dataType: 'JSON',
                data: {
                    'action' : 'yani_resend_for_approval',
                    'propid' : prop_id
                },
                beforeSend: function( ) {
                    yani_processing_modal( processing_text );
        ...
        if( $('#invoice-print-button').length > 0 ) {
            ...
            $('#invoice-print-button').click(function (e) {
                ...
                $.ajax({
                    ...
                    url: ajax_url,
                    data: {
                        'action': 'yani_create_invoice_print',
        ...
        var yani_login_user_before_submit = function(currnt) {
            var $form = currnt.parents('form');
            var $messages = $('#sumission_login_register_msgs');

            var sp_username = $('#sp_username').val();
            var sp_password = $('#sp_password').val();
            var security = $('#yani_register_security2').val();
            var yani_loggedin_success = $('#yani_loggedin_success').val();

            if(yani_loggedin_success == 1 ) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    'yani_register_security2': security,
                ...
                success: function( response ) {
                    if( response.success ) {
                        ...
                        $('#submit_property_form').append('<input type="hidden" name="yani_loggedin_success" id="yani_loggedin_success" value="1">');
                        $('#submit_property_form').submit();
        ...
        $('input[name="yani_agent_display_option"]').on('click', function() {
            var $this = $(this);
        ...
        var yani_register_login_user_before_submit = function ( currnt ) {
            ...
            var register_security = $('#yani_register_security2').val();

            var yani_registered_success = $('#yani_registered_success').val();

            if(yani_registered_success == 1) {
                $('#submit_property_form').submit();
                return;
            }
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {
                    'action': 'yani_register_user_with_membership',
                    'username': username,
                    'useremail': useremail,
                    ...
                    'last_name': '',
                    'user_role': user_role,
                    'yani_register_security2': register_security,
                    'is_submit_listing': 'yes',
                },
                beforeSend: function( ) {
                    currnt.find('.yani-loader-js').addClass('loader-show');
                ...
                success: function( response ) {
                    if( response.success ) {
                        $messages.empty().append('<div class="alert alert-success" role="alert"><i class="yani-icon icon-check-circle-1 mr-1"></i>'+ response.msg +'</div>');
                        $('#submit_property_form').append('<input type="hidden" name="yani_registered_success" id="yani_registered_success" value="1">');
                        $('#submit_property_form').submit();
                    } else {
                        $messages.empty().append('<div class="alert alert-danger" role="alert"><i class="yani-icon icon-check-circle-1 mr-1"></i>'+ response.msg +'</div>');
                    }
            ...
            if (add_new_property.length > 0) {
                ...
                add_new_property.on('click', function (e) {
                    ...
                    if( login_while_submission == 1 ) {
                        yani_login_user_before_submit(currnt);
                        
                    } else {
                        yani_register_login_user_before_submit(currnt);
                    }
                    return;
                });
            }
        ...
        var yani_validation = function( field_required ) {
            if( field_required != 0 ) {
                return true;
            }
            return false;
        ...
        $( "#save_as_draft" ).on('click', function() {
            ...
            $.ajax({
                ...
                beforeSend: function( ) {
                    $('.yani-loader-js').addClass('loader-show');
                },
                complete: function(){
                    $('.yani-loader-js').removeClass('loader-show');
                },
                success: function( response ) {
            ...
            if(form.length > 0){ 
                form.validate({ 
                    ...
                    submitHandler: function(form) {
                        $(".yani-submit-js").attr("disabled", true);
                        $('.yani-submit-js .yani-loader-js').addClass('loader-show');
                        form.submit();
                    }
                });
        ...
        /*  Property additional Features
         /* ------------------------------------------------------------------------ */
        $( "#yani_additional_details_main" ).sortable({
            revert: 100,
        ...
        $( '.add-additional-row' ).click(function( e ){
            ...
            var newAdditionalDetail = '<tr>'+
                ...
                '<input class="form-control" type="text" name="additional_features['+numVal+'][yani_additional_feature_title]" id="yani_additional_feature_title_'+numVal+'" value="">'+
                '</td>'+
                '<td class="table-half-width">'+
                '<input class="form-control" type="text" name="additional_features['+numVal+'][yani_additional_feature_value]" id="yani_additional_feature_value_'+numVal+'" value="">'+
                '</td>'+
                '<td class="">'+
                '<a class="sort-additional-row btn btn-light-grey-outlined"><i class="yani-icon icon-navigation-menu"></i></a>'+
                '</td>'+
                '<td>'+
                '<button data-remove="'+numVal+'" class="remove-additional-row btn btn-light-grey-outlined"><i class="yani-icon icon-close"></i></button>'+
                '</td>'+
                '</tr>';

            $( '#yani_additional_details_main').append( newAdditionalDetail );
        ...
        $( '#add-floorplan-row' ).click(function( e ){
            ...
            var newFloorPlan = '' +
                '<div class="yani-floorplan-clone">'+
                '<div class="row">'+
                ...
                '<label for="floor_plans['+numVal+'][yani_plan_title]">'+plan_title_text+'</label>'+
                '<input name="floor_plans['+numVal+'][yani_plan_title]" type="text" id="yani_plan_title_'+numVal+'" class="form-control">'+
                '</div>'+
                '</div>'+
                '<div class="col-md-6 col-sm-12">'+
                '<div class="form-group">'+
                '<label for="floor_plans['+numVal+'][yani_plan_rooms]">'+plan_bedrooms_text+'</label>'+
                '<input name="floor_plans['+numVal+'][yani_plan_rooms]" type="text" id="yani_plan_rooms_'+numVal+'" class="form-control">'+
                '</div>'+
                '</div>'+
                '<div class="col-md-6 col-sm-12">'+
                '<div class="form-group">'+
                '<label for="floor_plans['+numVal+'][yani_plan_bathrooms]">'+plan_bathrooms_text+'</label>'+
                '<input name="floor_plans['+numVal+'][yani_plan_bathrooms]" type="text" id="yani_plan_bathrooms_'+numVal+'" class="form-control">'+
                '</div>'+
                '</div>'+
                '<div class="col-md-6 col-sm-12">'+
                '<div class="form-group">'+
                '<label for="floor_plans['+numVal+'][yani_plan_price]">'+plan_price_text+'</label>'+
                '<input name="floor_plans['+numVal+'][yani_plan_price]" type="text" id="yani_plan_price_'+numVal+'" class="form-control">'+
                '</div>'+
                '</div>'+
                '<div class="col-md-6 col-sm-12">'+
                '<div class="form-group">'+
                '<label for="floor_plans['+numVal+'][yani_plan_price_postfix]">'+plan_price_postfix_text+'</label>'+
                '<input name="floor_plans['+numVal+'][yani_plan_price_postfix]" type="text" id="yani_plan_price_postfix_'+numVal+'" class="form-control">'+
                '</div>'+
                '</div>'+
                '<div class="col-md-6 col-sm-12">'+
                '<div class="form-group">'+
                '<label for="floor_plans['+numVal+'][yani_plan_size]">'+plan_size_text+'</label>'+
                '<input name="floor_plans['+numVal+'][yani_plan_size]" type="text" id="yani_plan_size_'+numVal+'" class="form-control">'+
                '</div>'+
                '</div>'+
                '<div class="col-md-6 col-sm-12">'+
                '<div class="form-group">'+
                '<label for="floor_plans['+numVal+'][yani_plan_image]">'+plan_image_text+'</label>'+
                ...
                '<input name="floor_plans['+numVal+'][yani_plan_image]" type="hidden" id="yani_plan_image_'+numVal+'" class="yani_plan_image form-control" value="">'+
                '<small class="form-text text-muted">'+yani_vars.plan_upload_size+'</small>'+
                '<div class="errors-log"></div>'+
                '<div class="progress yani-hidden"></div>'+
                '</div>'+
                '</div>'+
                '</div>'+
                '</div>'+
                '<div class="col-md-12 col-sm-12">'+
                '<div class="form-group">'+
                '<label for="floor_plans['+numVal+'][yani_plan_description]">'+plan_description_text+'</label>'+
                '<textarea name="floor_plans['+numVal+'][yani_plan_description]" rows="4" id="yani_plan_description_'+numVal+'" class="form-control"></textarea>'+
                '</div>'+
                '</div>'+
                '</div>'+
                '<hr>'+
            ...
            $( '#yani_floor_plans_main').append( newFloorPlan );
            removeFloorPlans();
            bindFloorPlanEvents();
        });
        ...
        var removeFloorPlans = function (){
            ...
            $( '.remove-floorplan-row').click(function( event ){
                event.preventDefault();
                var $this = $( this );
                $this.parents( '.yani-floorplan-clone' ).remove();
            });
        }
        removeFloorPlans();
        ...
        $( '#add-subproperty-row' ).click(function( e ){
            ...
            var newSubProperty = '' +
                ...
                '</div>'+
                '<div class="form-group">'+
                '<label for="yani_multi_units['+numVal+'][yani_mu_title]">'+mu_title_text+'</label>'+
                '<input name="yani_multi_units['+numVal+'][yani_mu_title]" type="text" class="form-control">'+
                '</div>'+
                '</div>'+
                '<div class="col-md-6 col-sm-12">'+
                '<div class="form-group">'+
                '<label for="yani_multi_units['+numVal+'][yani_mu_beds]">'+mu_beds_text+'</label>'+
                '<input name="yani_multi_units['+numVal+'][yani_mu_beds]" type="text" class="form-control">'+
                '</div>'+
                '</div>'+
                '<div class="col-md-6 col-sm-12">'+
                '<div class="form-group">'+
                '<label for="yani_multi_units['+numVal+'][yani_mu_baths]">'+mu_baths_text+'</label>'+
                '<input name="yani_multi_units['+numVal+'][yani_mu_baths]" type="text" class="form-control">'+
                '</div>'+
                '</div>'+
                '<div class="col-md-6 col-sm-12">'+
                '<div class="form-group">'+
                '<label for="yani_multi_units['+numVal+'][yani_mu_size]">'+mu_size_text+'</label>'+
                '<input name="yani_multi_units['+numVal+'][yani_mu_size]" type="text" class="form-control">'+
                '</div>'+
                '</div>'+
                '<div class="col-md-6 col-sm-12">'+
                '<div class="form-group">'+
                '<label for="yani_multi_units['+numVal+'][yani_mu_size_postfix]">'+mu_size_postfix_text+'</label>'+
                '<input name="yani_multi_units['+numVal+'][yani_mu_size_postfix]" type="text" class="form-control">'+
                '</div>'+
                '</div>'+
                '<div class="col-md-6 col-sm-12">'+
                '<div class="form-group">'+
                '<label for="yani_multi_units['+numVal+'][yani_mu_price]">'+mu_price_text+'</label>'+
                '<input name="yani_multi_units['+numVal+'][yani_mu_price]" type="text" class="form-control">'+
                '</div>'+
                '</div>'+
                '<div class="col-md-6 col-sm-12">'+
                '<div class="form-group">'+
                '<label for="yani_multi_units['+numVal+'][yani_mu_price_postfix]">'+mu_price_postfix_text+'</label>'+
                '<input name="yani_multi_units['+numVal+'][yani_mu_price_postfix]" type="text" class="form-control">'+
                '</div>'+
                '</div>'+
                '<div class="col-md-6 col-sm-12">'+
                '<div class="form-group">'+
                '<label for="yani_multi_units['+numVal+'][yani_mu_type]">'+mu_type_text+'</label>'+
                '<input name="yani_multi_units['+numVal+'][yani_mu_type]" type="text" class="form-control">'+
                '</div>'+
                '</div>'+
                '<div class="col-md-6 col-sm-12">'+
                '<div class="form-group">'+
                '<label for="yani_multi_units['+numVal+'][yani_mu_availability_date]">'+mu_availability_text+'</label>'+
                '<input name="yani_multi_units['+numVal+'][yani_mu_availability_date]" type="text" class="form-control">'+
                '</div>'+
                '</div>'+
                '</div>'+
                '<hr>'+
        ...
        var removeSubProperty = function (){
            ...
            $( '.remove-subproperty-row').click(function( event ){
                event.preventDefault();
                var $this = $( this );
                $this.parents( '.yani-units-clone' ).remove();
            });
        }
        removeSubProperty();
        ...
        var propertyAttachmentEvents = function() {
            ...
            $( "#yani_attachments_container" ).sortable({
                revert: 100,
            ...
            $('.attachment-delete').on('click', function(e){
                ...
                var ajax_request = $.ajax({
                    ...
                    dataType: 'json',
                    data: {
                        'action': 'yani_remove_property_thumbnail',
                        'prop_id': prop_id,
                        'thumb_id': thumb_id,
        ...
        var property_gallery_images = function() {
            ...
            $( "#yani_property_gallery_container" ).sortable({
            ...
            var plup_uploader = new plupload.Uploader({
                ...
                container: 'yani_gallery_dragDrop',
                drop_element: 'yani_gallery_dragDrop',
                url: ajax_url + "?action=yani_property_img_upload&verify_nonce=" + verify_nonce,
                filters: {
                    mime_types : [
            ...
            plup_uploader.bind('FilesAdded', function(up, files) {
                ...
                plupload.each(files, function(file) {
                    yani_thumbs += '<div id="thumb-holder-' + file.id + '" class="col-md-2 col-sm-4 col-6 property-thumb">' + '' + '</div>';
                });
                document.getElementById('yani_property_gallery_container').innerHTML += yani_thumbs;
                up.refresh();
                plup_uploader.start();
            });
            ...
            plup_uploader.bind('Error', function( up, err ) {
                document.getElementById('yani_errors').innerHTML += "<br/>" + "Error #" + err.code + ": " + err.message;
            });
            ...
            plup_uploader.bind('FileUploaded', function ( up, file, ajax_response ) {
                ...
                if ( response.success ) {
                    ...
                    var gallery_thumbnail = '<img class="img-fluid" src="' + response.url + '" alt="" />' +
                        ...
                        '<button class="icon icon-fav icon-featured" data-property-id="'+ 0 +'" data-attachment-id="' + response.attachment_id + '"><i class="yani-icon icon-rating-star full-star"></i></button>'+
                        '<button class="icon icon-delete" data-property-id="'+ 0 +'" data-attachment-id="' + response.attachment_id + '"><span class="btn-loader yani-loader-js"></span><i class="yani-icon icon-remove-circle"></i></button>'+
                        '</div>'+
        ...
        var yani_property_attachments = function() {

            var atch_uploader = new plupload.Uploader({
                browse_button: 'select_attachments',
                file_data_name: 'property_attachment_file',
                url: ajax_url + "?action=yani_property_attachment_upload&verify_nonce=" + verify_nonce,
                filters: {
                    mime_types : [
            ...
            atch_uploader.bind('FilesAdded', function(up, files) {
                ...
                plupload.each(files, function(file) {
                    yani_thumbs += '<tr id="attachment-holder-' + file.id + '" class="attach-thumb">' + '' + '</tr>';
                });
                document.getElementById('yani_attachments_container').innerHTML += yani_thumbs;
                up.refresh();
                atch_uploader.start();
            });
            ...
            atch_uploader.bind('Error', function( up, err ) {
                document.getElementById('yani_atach_errors').innerHTML += "<br/>" + "Error #" + err.code + ": " + err.message;
            });
            ...
            atch_uploader.bind('FileUploaded', function ( up, file, ajax_response ) {
                ...
                if ( response.success ) {
                    ...
                    var attachment_file = ''+
                        ...
                        '</td>'+
                        '<td>'+
                            '<a href="'+ response.url +'" target="_blank" class="btn btn-light-grey-outlined"><i class="yani-icon icon-download-bottom"></i></a>'+
                        '</td>'+
                        '<td>'+
                            '<button data-attach-id="' + 0 + '"  data-attachment-id="' + response.attachment_id + '" class="attachment-delete btn btn-light-grey-outlined"><i class="yani-icon icon-close"></i></button>'+
                        '</td>'+
                        '<td class="sort-attachment">'+
                            '<a class="btn btn-light-grey-outlined"><i class="yani-icon icon-navigation-menu"></i></a>'+
                        '</td>'+
        ...
        var floorPlanImage = function($button) {
            ...
            var parent = $this.parents(".yani-floorplan-clone");
            ...
            uploader_floor.bind('UploadProgress', function(up, file) {
                parent.find(".progress").removeClass('yani-hidden');
            ...
            uploader_floor.bind('FileUploaded', function ( up, file, ajax_response ) {
                ...
                if ( response.success ) {
                    uploadErrors.html("");
                    parent.find(".yani_plan_image").val(response.full_image);
                    parent.find(".floor-thumb").attr('src',response.full_image);
                    parent.find(".progress").html("");
                    parent.find(".progress").addClass('yani-hidden');
                } else {
                    console.log ( response );
        ...
        var bindFloorPlanEvents = function () {
            var $yaniFloorplanClone = $(".yani-floorplan-clone");

            $.each($yaniFloorplanClone, function( index, value ) {
        ...
        var thread_message_attachment = function() {
            ...
            var uploader = new plupload.Uploader({
                ...
                url: ajax_url + "?action=yani_message_attacment_upload&verify_nonce=" + verify_nonce,
                filters: {
        ...
        var messageAttachment = function() {
            ...
            $( '.remove-message-attachment' ).on( 'click', function () {
                ...
                var ajax_request = $.ajax({
                    ...
                    dataType: 'json',
                    data: {
                        'action': 'yani_remove_message_attachment',
        ...
        $('.yani_delete_msg_thread').on('click', function(e) {
            e.preventDefault();
                ...
                callback: function (result) {
                    ...
                    if(result==true) {
                        ...
                        $.ajax({
                            ...
                            url: ajax_url,
                            data: {
                                'action': 'yani_delete_message_thread',
                                'thread_id': thread_id,
                                'sender_id': sender_id,
        ...
        $('.yani_delete_message').on('click', function(e) {
            e.preventDefault();
