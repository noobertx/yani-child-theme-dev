...
$enable_save_search = _yani_theme()->get_option('enable_disable_save_search');
...
$listing_qry = apply_filters( 'yani20_property_filter', $listing_args );
$listing_qry = _yani_property_listing()->prop_sort ( $listing_qry );
$search_query = new WP_Query( $listing_qry );  
$total_properties = $search_query->found_posts; 

$enable_search = _yani_theme()->get_option('enable_halfmap_search', 1);
$search_style = _yani_theme()->get_option('halfmap_search_layout', 'v4');
...
<section class="half-map-wrap map-on-left clearfix">
    <div id="map-view-wrap" class="half-map-left-wrap">
        <div class="map-wrap">
            ...
            <?php if(_yani_map()->get_map_system() == 'google') { ?>
        ...
        <div class="page-title-wrap">
            <div class="d-flex align-items-center">
                <div class="page-title flex-grow-1">
                    <span><?php echo esc_attr($total_properties); ?></span> <?php esc_html_e('Results Found', _yani_theme()->get_text_domain());?>
                </div>
            ...
            <div id="yani_ajax_container">
                ...
                if ( $search_query->have_posts() ) :
                    ...
                    echo '<div class="search-no-results-found">';
                        esc_html_e('No results found', _yani_theme()->get_text_domain());
                    echo '</div>';
                ...
                <?php _yani_post()->ajax_pagination( $search_query->max_num_pages ); ?>
            </div>
