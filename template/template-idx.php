 ...
 */
global $yani_local, $post, $page_bg;

$page_bg = 'page-content-wrap';
$content_area = $row_class = '';

$page_sidebar = get_post_meta( $post->ID, 'yani_page_sidebar', true );
$page_title = get_post_meta( $post->ID, 'yani_page_title', true );
$page_breadcrumb = get_post_meta( $post->ID, 'yani_page_breadcrumb', true );
$page_background = get_post_meta( $post->ID, 'yani_page_background', true );
...
$sidebar_meta = _yani_template()->get_sidebar_meta($post->ID);
?>
...
<section class="page-wrap">
    <div class="container">
        ...
        <div class="row <?php echo esc_attr( $row_class ); ?>">
            ...
            <div class="col-lg-4 col-md-12 bt-sidebar-wrap <?php if( $sticky_sidebar['page_sidebar'] != 0 ){ echo 'yani_sticky'; }?>">
