...
$number_of_agents = _yani_theme()->get_option('num_of_agents');
if(!$number_of_agents){
    $number_of_agents = 9;
}
$tax_query = array();
...
$agent_cats = get_post_meta( $page_id, 'yani_agent_category', false );
$agent_cities = get_post_meta( $page_id, 'yani_agent_city', false );
$order = get_post_meta( $page_id, 'yani_agent_order', true );
$orderby = get_post_meta( $page_id, 'yani_agent_orderby', true );
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 bt-content-wrap right-bt-content-wrap">
                ...
                <?php _yani_post()->render_pagination( $agents_query->max_num_pages ); wp_reset_query(); ?>

            </div><!-- bt-content-wrap -->
            <div class="col-lg-4 col-md-12 bt-sidebar-wrap left-bt-sidebar-wrap <?php if( $sticky_sidebar['agent_sidebar'] != 0 ){ echo 'yani_sticky'; }?>">
                <?php get_sidebar('yani_agents'); ?>
            </div><!-- bt-sidebar-wrap -->
        </div><!-- row -->
    </div><!-- container -->
