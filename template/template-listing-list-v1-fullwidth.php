...
$listing_args = apply_filters( 'yani20_property_filter', $listing_args );
$listing_args = _yani_property_listing()->prop_sort ( $listing_args );

$listings_query = new WP_Query( $listing_args );
$total_listing_found = $listings_query->found_posts;

$listings_tabs = get_post_meta( $post->ID, 'yani_listings_tabs', true );
$mb = '';
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <?php _yani_theme()->render_pagination( $listings_query->max_num_pages ); ?>
