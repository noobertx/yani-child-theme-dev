...
$prop_ids = explode(',', $_COOKIE['yani_compare_listings']);
            ...
            <div class="col-lg-12 col-md-12">
                ...
                if( !empty($prop_ids) ) {
                    ...
                    if( $the_query->have_posts() ): 
                        ...
                        $address = get_post_meta( get_the_ID(), 'yani_property_address', true );
                        $zipcode = get_post_meta( get_the_ID(), 'yani_property_zip', true );
                        $country = get_post_meta( get_the_ID(), 'yani_property_country', true );
                        $type = _yani_taxonomy()->get_taxonomy_simple('property_type');
                        $status = _yani_taxonomy()->get_taxonomy_simple('property_status');
                        ...
                        $neighbourhood = _yani_taxonomy()->get_taxonomy_simple('property_area');

                        $prop_id = get_post_meta( get_the_ID(), 'yani_property_id', true );
                        $property_size = get_post_meta( get_the_ID(), 'yani_property_size', true );
                        $bedrooms = get_post_meta( get_the_ID(), 'yani_property_bedrooms', true );
                        $bathrooms = get_post_meta( get_the_ID(), 'yani_property_bathrooms', true );
                        $year_built = get_post_meta( get_the_ID(), 'yani_property_year', true );
                        $garage = get_post_meta( get_the_ID(), 'yani_property_garage', true );
                        $garage_size = get_post_meta( get_the_ID(), 'yani_property_garage_size', true );
                        ...
                        $garage_label = ($garage > 1 ) ? _yani_theme()->get_option('spl_garages', 'Garages') : _yani_theme()->get_option('spl_garage', 'Garage');
                            ...
                            $listing_price .= '<td>' . _yani_listing()->get_price() . '</td>';
                            ...
                            if( !empty($property_size) ) {
                                $prop_size .= '<td>' . _yani_listing()->get_size( 'after' ) . '</td>';
                            } else {
                                $prop_size .= '<td>---</td>';
                            }
                ...
                <div class="compare-table">
                    <table class="table-striped table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td><strong><?php esc_html_e('Title', _yani_theme()->get_text_domain()); ?></strong></td>
                                <?php echo $listing_title; ?>
                            </tr>
                            <tr>
                                <td><strong><?php echo _yani_theme()->get_option('spl_price', 'Price'); ?></strong></td>
                                <?php echo $listing_price; ?>
                            </tr>
                            <tr>
                                <td><strong><?php echo _yani_theme()->get_option('spl_prop_type', 'Property Type'); ?></strong></td>
                                <?php echo $prop_type; ?>
                            </tr>
    
                            <tr>
                                <td><strong><?php echo _yani_theme()->get_option('spl_address', 'Address'); ?></strong></td>
                                <?php echo $prop_address; ?>
                            </tr>
                            <tr>
                                <td><strong><?php echo _yani_theme()->get_option( 'spl_city', 'City' ); ?></strong></td>
                                <?php echo $prop_city; ?>
                            </tr>
                            <tr>
                                <td><strong><?php echo _yani_theme()->get_option('spl_state', 'County/State'); ?></strong></td>
                                <?php echo $prop_state; ?>
                            </tr>
                            <tr>
                                <td><strong><?php echo _yani_theme()->get_option('spl_zip', 'Zip/Postal Code'); ?></strong></td>
                                <?php echo $prop_zipcode; ?>
                            </tr>
                            <tr>
                                <td><strong><?php echo _yani_theme()->get_option('spl_country', 'Country'); ?></strong></td>
                                <?php echo $prop_country; ?>
                            </tr>
                            <tr>
                                <td><strong><?php echo _yani_theme()->get_option('spl_prop_size', 'Property Size'); ?></strong></td>
                                <?php echo $prop_size; ?>
                            </tr>
                            <tr>
                                <td><strong><?php echo _yani_theme()->get_option('spl_prop_id', 'Property ID'); ?></strong></td>
                            ...
                            <tr>
                                ...
                                foreach ( $prop_ids as $post_ID ) :
                                    ...
                                    if ( in_array( $data, $compare_terms[ $post_ID ] ) ) :
                                        ...
                                        echo '<td><i class="yani-icon icon-check-circle-1 text-success"></i></td>';

                                    else :

                                        echo '<td><i class="yani-icon icon-remove-circle text-danger"></i></td>';
