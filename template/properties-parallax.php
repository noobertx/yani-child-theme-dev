...
$latest_listing_args = _yani_property_listing()->prop_sort ( $latest_listing_args );
...
if ( $listings_query->have_posts() ) :
	...
	$prop_images        = get_post_meta( get_the_ID(), 'yani_property_images', false );
	$prop_address       = get_post_meta( get_the_ID(), 'yani_property_map_address', true );
	$prop_featured      = get_post_meta( get_the_ID(), 'yani_featured', true );
...
<?php _yani_post()->render_pagination( $listings_query->max_num_pages ); ?>
