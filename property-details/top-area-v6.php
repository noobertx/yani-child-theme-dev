...
$listing_images = rwmb_meta( 'yani_property_images', 'type=plupload_image&size='.$size, $post->ID );
$i = 0;
					...
					foreach( $listing_images as $image ) { $i++; 
						...
						<?php } ?>
							<a href="#" data-slider-no="<?php echo esc_attr($i); ?>" data-toggle="modal" data-target="#property-lightbox" class="houzez-trigger-popup-slider-js swipebox img-wrap-<?php echo esc_attr($i); ?>">
								...
								<div class="img-wrap-3-text"><?php echo $total_images-3; ?> <?php echo esc_html__('More', _yani_theme()->get_text_domain()); ?></div>
								<?php } ?>
