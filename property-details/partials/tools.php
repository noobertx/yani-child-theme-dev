...
<ul class="item-tools">
    ...
    <?php if( _yani_theme()->get_option('prop_detail_favorite') != 0 ) { ?>
    ...
    <?php if( _yani_theme()->get_option('prop_detail_share') != 0 ) { ?>
    <li class="item-tool houzez-share">
        <span class="item-tool-share dropdown-toggle" data-toggle="dropdown">
            <i class="yani-icon icon-share"></i>
        </span><!-- item-tool-favorite -->
    ...
    <?php if( _yani_theme()->get_option('print_property_button') != 0 ) { ?>
    <li class="item-tool houzez-print" data-propid="<?php echo intval($post->ID); ?>">
        <span class="item-tool-compare">
            <i class="yani-icon icon-print-text"></i>
