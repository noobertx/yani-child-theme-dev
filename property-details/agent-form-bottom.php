...
$section_title = isset($ele_settings['section_title']) && !empty($ele_settings['section_title']) ? $ele_settings['section_title'] : _yani_theme()->get_option('sps_contact_info', 'Contact Information');
...
<div class="property-contact-agent-wrap property-section-wrap" id="property-contact-agent-wrap">
	<div class="block-wrap">
		...
		<div class="block-title-wrap d-flex justify-content-between align-items-center">
			...
			<?php if ( $return_array['is_single_agent'] == true && _yani_theme()->get_option('agent_view_listing') ) : ?>
			<a class="btn btn-primary btn-slim" href="<?php echo esc_url($return_array['link']); ?>" target="_blank"><?php echo _yani_theme()->get_option('spl_con_view_listings', 'View listings'); ?></a>
			<?php endif; ?>
