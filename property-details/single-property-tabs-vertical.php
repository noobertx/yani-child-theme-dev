    ...
    <ul class="nav nav-tabs nav-justified">
        ...
        if ($layout): foreach ($layout as $key => $value) {
            ...
            switch($key) {
                ...
                case 'description':
                    echo $li_start;
                    echo '<a class="nav-link '.$a_active.'" href="#property-description" data-toggle="tab"><i class="yani-icon icon-task-list-plain-1"></i></a>';
                    echo $li_end;
                    $i++;
                    break;
                ...
                case 'address':
                    echo $li_start;
                    echo '<a class="nav-link '.$a_active.'" href="#property-address" data-toggle="tab"><i class="yani-icon icon-maps"></i></a>';
                    echo $li_end;
                    $i++;
                    break;
                ...
                case 'details':
                    echo $li_start;
                    echo '<a class="nav-link '.$a_active.'" href="#property-details" data-toggle="tab"><i class="yani-icon icon-house-nature"></i></a>';
                    echo $li_end;
                    $i++;
                    break;
                ...
                case 'features':
                    echo $li_start;
                    echo '<a class="nav-link '.$a_active.'" href="#property-features" data-toggle="tab"><i class="yani-icon icon-cog"></i></a>';
                    echo $li_end;
                    $i++;
                    break;
                ...
                case 'floor_plans':
                    if( isset($floor_plans[0]['yani_plan_title']) && !empty( $floor_plans[0]['yani_plan_title'] ) ) {
                        echo $li_start;
                        echo '<a class="nav-link '.$a_active.'" href="#property-floor-plans" data-toggle="tab"><i class="yani-icon icon-real-estate-dimensions-plan-1"></i></a>';
                        echo $li_end;
                        $i++;
                    }
                    break;
                ...
                case 'video':
                    ...
                    if( !empty($video_url ) ) {
                        echo $li_start;
                        echo '<a class="nav-link '.$a_active.'" href="#property-video" data-toggle="tab"><i class="yani-icon icon-social-video-youtube-clip"></i></a>';
                        echo $li_end;
                        $i++;
                    }
                    break;
                ...
                case 'virtual_tour':
                    if( !empty($virtual_tour) ) {
                        echo $li_start;
                        echo '<a class="nav-link '.$a_active.'" href="#property-virtual-tour" data-toggle="tab"><i class="yani-icon icon-social-video-youtube-clip"></i></a>';
                        echo $li_end;
                        $i++;
                    }
                    break;
