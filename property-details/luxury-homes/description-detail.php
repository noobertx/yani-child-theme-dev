<?php
$attachments = get_post_meta(get_the_ID(), 'yani_attachments', false);
$documents_download = yani_option('documents_download');

$prop_id = yani_get_listing_data('property_id');
$prop_price = yani_get_listing_data('property_price');
$prop_size = yani_get_listing_data('property_size');
...
$property_status = yani_taxonomy_simple('property_status');
$property_type = yani_taxonomy_simple('property_type');
$garage_size = yani_get_listing_data('property_garage_size');
$additional_features_enable = yani_get_listing_data('additional_features_enable');
$additional_features = get_post_meta( get_the_ID(), 'additional_features', true);

$icon_prop_id = yani_option('icon_prop_id', false, 'url' );
$icon_bedrooms = yani_option('icon_bedrooms', false, 'url' );
$icon_rooms = yani_option('icon_rooms', false, 'url' );
$icon_bathrooms = yani_option('icon_bathrooms', false, 'url' );
$icon_prop_size = yani_option('icon_prop_size', false, 'url' );
$icon_prop_land = yani_option('icon_prop_land', false, 'url' );
$icon_garage_size = yani_option('icon_garage_size', false, 'url' );
$icon_garage = yani_option('icon_garage', false, 'url' );
$icon_year = yani_option('icon_year', false, 'url' );

$bathrooms_text = ($bathrooms > 1 ) ? yani_option('spl_bathrooms', 'Bathrooms') : yani_option('spl_bathroom', 'Bathroom');

$bedrooms_text = ($bedrooms > 1 ) ? yani_option('spl_bedrooms', 'Bedrooms') : yani_option('spl_bedroom', 'Bedroom');

$rooms_text = ($rooms > 1 ) ? yani_option('spl_rooms', 'Rooms') : yani_option('spl_room', 'Room');

$garage_label = ($garage > 1 ) ? yani_option('spl_garages', 'Garages') : yani_option('spl_garage', 'Garage');


$hide_fields = yani_option('hide_detail_prop_fields');
?>
<div class="fw-property-description-wrap fw-property-section-wrap" id="property-description-wrap">
	<div class="block-wrap">
		<div class="block-title-wrap">
			<h2><?php echo yani_option('sps_description', 'Description'); ?></h2>	
		...
		<div class="block-content-wrap">
			...
			<div class="fw-property-documents-wrap">
				<div class="block-title-wrap">
					<h3>
						<span><?php echo yani_option('sps_documents', 'Property Documents'); ?></span>
					</h3>
				</div><!-- block-title-wrap -->
				<div class="property-documents">
					<?php 
					foreach( $attachments as $attachment_id ):
						$attachment_meta = yani_get_attachment_metadata($attachment_id); 

						if(!empty($attachment_meta )):
						?>
						<div class="property-document-title">
							<i class="yani-icon icon-task-list-plain-1 mr-1"></i> <?php echo esc_attr( $attachment_meta->post_title ); ?> - 
			...
			<div class="fw-property-details-wrap">
				<div class="block-title-wrap">
					<h3>
						<span><?php echo yani_option('sps_details', 'Details'); ?></span>
					</h3>
				</div><!-- block-title-wrap -->
				<div class="d-flex justify-content-center fw-property-amenities-wrap clearfix">
					...
					<div class="fw-property-amenities">
						<div class="d-flex align-items-center">
							...
							<div class="fw-property-amenities-data">
								<?php echo yani_option('spl_prop_id', 'Property ID'); ?><br>
								<?php echo yani_propperty_id_prefix( $prop_id ); ?>
							</div>
						</div>
					</div>
					<?php } ?>
        			...
        			<div class="fw-property-amenities">
						<div class="d-flex align-items-center">
							...
							<?php } ?>
							<div class="fw-property-amenities-data">
								<?php echo yani_option('spl_prop_size', 'Property Size'); ?><br>
								<?php echo yani_property_size( 'after' ); ?>
							</div>
						</div>
					</div>
					<?php } ?>
					...
					<div class="fw-property-amenities">
						<div class="d-flex align-items-center">
							...
							<?php } ?>
							<div class="fw-property-amenities-data">
								<?php echo yani_option('spl_land', 'Land Area'); ?><br>
								<?php echo yani_property_land_area( 'after' ); ?>
							</div>
						</div>
					</div>
					<?php } ?>
			        ...
			        <div class="fw-property-amenities">
				        <div class="d-flex align-items-center">
							...
							<div class="fw-property-amenities-data">
								<?php echo yani_option('spl_garage_size', 'Garage Size'); ?><br>
			        ...
			        <div class="fw-property-amenities">
						<div class="d-flex align-items-center">
							...
							<?php } ?>
							<div class="fw-property-amenities-data">
								<?php echo yani_option('spl_year_built', 'Year Built'); ?><br>
			            ...
			            if(!empty($fields_array)) {
			                foreach ( $fields_array as $value ) {
			                    ...
			                    if(!empty($data_value) && $hide_fields[$field_id] != 1) {
			                    	...
			                    	$custom_icon = yani_option('c_'.$field_id, false, 'url' );
			...
			<span class="small-text grey"><i class="yani-icon icon-calendar-3 mr-1"></i> <?php esc_html_e( 'Updated on', 'houzez' ); ?> <?php the_modified_time('F j, Y'); ?> <?php esc_html_e( 'at', 'houzez' ); ?> <?php the_modified_time('g:i a'); ?> </span>	
			<?php } ?>
