<?php
$google_map_address = yani_get_listing_data('property_map_address');
...
<div class="fw-property-address-wrap fw-property-section-wrap" id="property-address-wrap">
	<div class="block-wrap">
		<div class="block-title-wrap">
			<h2><?php echo yani_option('sps_address', 'Address'); ?></h2>
		...
		<?php if(yani_map_in_section() && yani_get_listing_data('property_map')) { ?>
