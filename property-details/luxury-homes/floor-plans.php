...
<div class="fw-property-floor-plans-wrap fw-property-section-wrap" id="property-floor-plans-wrap">
	<div class="block-wrap">
		<div class="block-title-wrap">
			<h2><?php echo yani_option('sps_floor_plans', 'Floor Plans'); ?></h2>
		...
		<div class="block-content-wrap">
			...
			<div class="floor-plans-tabs">
				<ul class="nav nav-tabs justify-content-center">
	                ...
	                foreach( $floor_plans as $pln ):
	                    ...
	                    $plan_title = isset($pln['yani_plan_title']) ? esc_attr($pln['yani_plan_title']) : '';
			...
			<div class="tab-content horizontal-tab-content" id="property-tab-content">
                ...
                foreach( $floor_plans as $plan ):
                    ...
                    $plantitle = isset($plan['yani_plan_title']) ? esc_attr($plan['yani_plan_title']) : '';
                    $yani_plan_price = isset($plan['yani_plan_price']) ? esc_attr($plan['yani_plan_price']) : '';
					...
					<div class="floor-plan-wrap">
						<div class="d-flex align-items-center">
							...
							<div class="floor-plan-right-wrap">
								...
								<?php if( !empty( $yani_plan_price ) ) { ?>
								<div>
									<?php esc_html_e( 'Price', 'houzez' ); ?>: 
			                        <strong><?php echo yani_get_property_price( $yani_plan_price ).$price_postfix; ?></strong>
			                     </div>
			                 	<?php } ?>
								...
								<div class="d-flex">
									...
									<div class="d-flex fw-property-floor-data-wrap align-items-center">
										<img class="img-fluid" src="<?php echo yani_IMAGE; ?>streamline-icon-hotel-double-bed-1@40x40.png" alt="">
										<div class="fw-property-floor-data">
											<?php esc_html_e( 'Rooms', 'houzez' ); ?>:<br>
											<?php echo esc_attr( $plan['yani_plan_rooms'] ); ?>
									...
									<div class="d-flex fw-property-floor-data-wrap align-items-center">
										<img class="img-fluid" src="<?php echo yani_IMAGE; ?>streamline-icon-bathroom-shower-1@40x40.png" alt="">
										<div class="fw-property-floor-data">
											<?php esc_html_e( 'Baths', 'houzez' ); ?>:<br>
											<?php echo esc_attr( $plan['yani_plan_bathrooms'] ); ?>
										</div><!-- fw-property-floor-data -->
									</div><!-- "d-flex -->
									<?php } ?>
									...
									<div class="d-flex fw-property-floor-data-wrap align-items-center">
										<img class="img-fluid" src="<?php echo yani_IMAGE; ?>streamline-icon-real-estate-dimensions-plan-1@40x40.png" alt="">
										<div class="fw-property-floor-data">
											<?php esc_html_e( 'Size', 'houzez' ); ?>:<br>
											<?php echo esc_attr( $plan['yani_plan_size'] ); ?>
										</div><!-- fw-property-floor-data -->
									</div><!-- "d-flex -->
									<?php } ?>
