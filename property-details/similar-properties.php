<?php
$show_similer = _yani_theme()->get_option( 'yani_similer_properties' );
$similer_criteria = _yani_theme()->get_option( 'yani_similer_properties_type', array( 'property_type', 'property_city' ) );
$listing_view = _yani_theme()->get_option( 'yani_similer_properties_view' );
$similer_count = _yani_theme()->get_option( 'yani_similer_properties_count' );
...
if( $show_similer ) {
	...
	$sort_by = _yani_theme()->get_option( 'similar_order', 'd_date' );
	if ( $sort_by == 'a_price' ) {
        $properties_args['orderby'] = 'meta_value_num';
        $properties_args['meta_key'] = 'yani_property_price';
        ...
        $properties_args['meta_key'] = 'yani_featured';
	...
	if ($wp_query->have_posts()) : ?>
		<div id="similar-listings-wrap" class="similar-property-wrap <?php echo esc_attr($wrap_class); ?>">
			<div class="block-title-wrap">
				<h2><?php echo _yani_theme()->get_option('sps_similar_listings', 'Similar Listings'); ?></h2>
